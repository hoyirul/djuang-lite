...
<div class="container-fluid">
  ...
  <a href="/operator/customer" class="btn btn-primary btn-md float-right"><i class="fa fa-arrow-left mr-1"></i> Back</a>
  <br><br>
  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="/operator/customer/{{ $tables->id }}" method="post">
        @csrf
        @method('PUT')
